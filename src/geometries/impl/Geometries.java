...
public final class Geometries extends Intersectable {
	...
	/**
	 * Private helper method to separate all the infinite bodies from the finite bodies. The infinite bodies stays in the
	 * geometries object. the finite bodies are added to sub-geometries object and then buildTree is applied on it.
	 */
	...
	/**
	 * Automatically builds a BVH tree structure out of the current geometries using a Midpoint Split along the longest
	 * axis.
	 */
