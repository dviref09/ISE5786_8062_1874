...
public class BeamLightTests {
	...
	final LightSource testLight = new BeamLight(testIntensity, testPosition, testDirection)
	...
	void testGetIntensity() {
		// ============ Equivalence Partitions Tests ==============
		// EP01: Point in front of the beamlight
