...
class VectorTests {
     ...
     */
    private static final String CONSTRUCTOR_FAILURE_MESSAGE = "Constructor should throw an exception when trying to " +
            "create zero vector.";
    ...
    private static final String SUBTRACTION_EP_FAILURE_MESSAGE = "Subtracting two vectors did not produce the " +
            "expected result.";
    private static final String SUBTRACTION_BVA_FAILURE_MESSAGE = "Subtracting a vector from itself should throw an " +
            "exception.";
    private static final String SCALING_EP_FAILURE_MESSAGE = "Scaling a vector by a scalar did not produce the " +
            "expected result.";
    private static final String SCALING_BVA_FAILURE_MESSAGE = "Scaling a vector by zero should throw an exception.";
    private static final String DOT_PRODUCT_EP_FAILURE_MESSAGE = "Dot product of two vectors did not produce the " +
            "expected result.";
    private static final String DOT_PRODUCT_BVA1_FAILURE_MESSAGE = "Dot product of orthogonal vectors should be zero.";
    private static final String DOT_PRODUCT_BVA2_FAILURE_MESSAGE = "Dot product of a vector with itself should return" +
            " the square of its length.";
    private static final String CROSS_PRODUCT_EP_FAILURE_MESSAGE = "Cross product of two vectors did not produce the " +
            "expected result.";
    private static final String CROSS_PRODUCT_BVA_FAILURE_MESSAGE = "Cross product of parallel vectors should throw " +
            "an exception.";
    private static final String LENGTH_FAILURE_MESSAGE = "Length of the vector did not produce the expected result.";
    private static final String LENGTH_SQUARED_FAILURE_MESSAGE = "Length squared of the vector did not produce the " +
            "expected result.";
    private static final String NORMALIZATION_LENGTH_FAILURE_MESSAGE = "Normalizing a vector did not produce a vector" +
            " with length 1.";
    private static final String NORMALIZATION_DIRECTION_FAILURE_MESSAGE = "Normalizing a vector did not produce a " +
            "vector in the same direction.";
    private static final String NORMALIZATION_OPPOSITE_DIRECTION_FAILURE_MESSAGE = "Normalizing a vector produced a " +
    ...
    void testCrossProduct() {
        ...
        assertThrows(IllegalArgumentException.class, () -> vector1.crossProduct(vector1Opp),
                CROSS_PRODUCT_BVA_FAILURE_MESSAGE);
    }
    ...
    void testNormalize() {
        ...
        // direction test
        // checking if the normalized vector is in the same direction as the original vector by checking if their
        // cross product
        // is a zero vector and their dot product is positive
        assertThrows(IllegalArgumentException.class, () -> vector1.crossProduct(result),
                NORMALIZATION_DIRECTION_FAILURE_MESSAGE);
