...
class PointTests {
    ...
    static final String SUBTRACTION_EP_FAILURE_MESSAGE = "Subtracting a point from another point did not return the " +
            "expected vector.";
    static final String SUBTRACTION_BV_FAILURE_MESSAGE = "Subtracting a point from itself did not throw the expected " +
            "exception.";
    static final String DISTANCE_SQUARED_EP_FAILURE_MESSAGE = "Distance squared between two different points did not " +
            "return the expected value.";
    static final String DISTANCE_SQUARED_BV_FAILURE_MESSAGE = "Distance squared between a point and itself did not " +
            "return 0.";
    static final String DISTANCE_EP_FAILURE_MESSAGE = "Distance between two different points did not return the " +
            "expected value.";
    ...
    void testSubtract() {
        ...
        assertThrows(IllegalArgumentException.class, () -> testPoint.subtract(testPoint),
                SUBTRACTION_BV_FAILURE_MESSAGE);
    }
    ...
    void testDistanceSquared() {
        ...
        assertEquals(expectedDistanceSquared, testPoint.distanceSquared(distancePoint), DELTA,
                DISTANCE_SQUARED_EP_FAILURE_MESSAGE);
        
        // =============== Boundary Values Tests ==================
        // BV01: Distance squared between a point and itself
        expectedDistanceSquared = 0;
        
        assertEquals(expectedDistanceSquared, testPoint.distanceSquared(testPoint), DELTA,
                DISTANCE_SQUARED_BV_FAILURE_MESSAGE);
    }
